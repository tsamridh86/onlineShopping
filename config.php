	...
	*/
		...
		*/
		...
		/*
			...
			items ( itemId int primary key, itemName varchar(50), sellerId int , price int , imgLoc varchar(50), category varchar(25), shape varchar(20));
		...
		*/
		$que = "create table if not exists items (itemId int primary key auto_increment, itemName varchar (50) , sellerId int references users(userId) , shape varchar (20),color varchar (30), price int , imgLoc varchar(50),category varchar(25));";
		$connect->query($que);
