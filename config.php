	...
	*/
		...
		*/
		...
		/*
			...
			items ( itemId int primary key, itemName varchar(50), sellerId int , price int , imgLoc varchar(50), category varchar(50), shape varchar(20),color(20),status char(1),type char(1), custId int );
		...
		*/
		$que = "create table if not exists items (itemId int primary key auto_increment, itemName varchar (50) , sellerId int references users(userId) , shape varchar (20),brand varchar(25), color varchar (30), price int , imgLoc varchar(50),category varchar(50),type char(1),custId int default null,status char(1) default 'N');";
		$connect->query($que);
